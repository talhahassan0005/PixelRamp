...
.bg-\[linear-gradient\(to_right\2c \#1e293b_1px\2c transparent_1px\)\2c linear-gradient\(to_bottom\2c \#1e293b_1px\2c transparent_1px\)\] {
...
.via-purple-600\/5 {
  ...
  --tw-gradient-stops: var(--tw-gradient-from), rgb(147 51 234 / 0.05) var(--tw-gradient-via-position), var(--tw-gradient-to);
}
.via-slate-900\/50 {
  --tw-gradient-to: rgb(15 23 42 / 0)  var(--tw-gradient-to-position);
...
.group:hover .group-hover\:bg-blue-600\/20 {
  background-color: rgb(37 99 235 / 0.2);
}

.group:hover .group-hover\:from-blue-600\/5 {
  --tw-gradient-from: rgb(37 99 235 / 0.05) var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(37 99 235 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}

.group:hover .group-hover\:to-purple-600\/5 {
